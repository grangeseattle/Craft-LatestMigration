...
public class CraftDriver {
	...
	/**
	 * Function to set the MobileWebDriver Object{@link MobileWebDriver} object
	 * 
	 * @param seeTestDriver
	 *            The See Test Driver
	 */
	...
	/**
	 * Function to return the object for MobileWebDriver {@link MobileWebDriver}
	 * object
	 * 
	 * @return Instance of the {@link MobileWebDriver} object
	 */
	...
	public WebElement findElementByPartialLinkText(String arg0) {
		if (isSeeTest()) {
			return ((MobileWebDriver) driver).findElementByPartialLinkText(arg0);
		} else if (isAppium()) {
	...
	public List<WebElement> findElementsByPartialLinkText(String arg0) {
		if (isSeeTest()) {
			return ((MobileWebDriver) driver).findElementsByPartialLinkText(arg0);
		} else if (isAppium()) {

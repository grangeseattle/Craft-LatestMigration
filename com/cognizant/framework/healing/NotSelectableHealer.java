...
public class NotSelectableHealer extends ObjectFortify {

	public NotSelectableHealer(Exception exception, By userDefinedLocator, String className, String methodName,
	...
	public WebElement heal() {
		...
		try {
			new WebDriverWait(driver, 60).until(ExpectedConditions.elementToBeSelected(userDefinedLocator));

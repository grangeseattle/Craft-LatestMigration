...
abstract class MasterPage extends ReusableLibrary {
	...
	// Links
	protected final By lnkSignOff =By.cssSelector("html > body > div > table > tbody > tr > td");
	...
	public Boolean isUserSignedOn() {
		return driverUtil.objectExists(lnkSignOff) && driver.findElement(lnkSignOff).isDisplayed();
	}
